                ...
                <div class="mb-[2rem]">
                    <div class="border-b-[1px] border-[#383B4B] sm:border-0">
                        <div class="flex justify-center md:justify-start">
                            <img :src="images" class="h-[13.938rem] sm:h-[35.75rem] md:h-[44.5rem]" alt="crew-img">
                        </div>
                    </div>
                </div>
                <div class="sm:w-[28.523rem] md:w-[38.375rem] self-start mx-auto md:mx-0 w-[20.4375rem] sm:w-[35.8125rem] md:w-[27.75rem] md:text-start">
                    <div class="details flex flex-col-reverse sm:flex-col">
                        <div class="bio mb-[2rem]">
                            ...
                            <p class="ff-serif text-[1rem] sm:text-[1.5rem] md:text=[2rem] text-[#8e9095] uppercase">{{ role }}</p>
                            <h2 class="text-[1.5rem] sm:text-[2.5rem] md:text-[3.5rem] ff-serif uppercase text-white mb-[1rem]">{{ contentName }}</h2>
                            <p class="mx-auto text-[0.938rem] sm:text-[1rem] md:text-[1.125rem]">{{ contentBio }}</p>
                        </div>
                        <div class="nav w-[5.5rem] md:w-[8.25rem] mx-auto md:mx-0 flex justify-between mb-[2rem] sm:mb-[2rem]">
